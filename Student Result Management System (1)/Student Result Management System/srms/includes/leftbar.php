<div class="left-sidebar bg-black-300 box-shadow ">
  ...
  <li class="has-children">
                                        <a href="#"><i class="fa fa-file-text"></i> <span>Institutions</span> <i class="fa fa-angle-right arrow"></i></a>
                                        <ul class="child-nav">
                                            <li><a href="create-subject.php"><i class="fa fa-bars"></i> <span>Create Institute</span></a></li>
                                            <li><a href="manage-subjects.php"><i class="fa fa fa-server"></i> <span>Manage Institute</span></a></li>
                                           <li><a href="add-subjectcombination.php"><i class="fa fa-newspaper-o"></i> <span>Add Institute Combination </span></a></li>
                                           <a href="manage-subjectcombination.php"><i class="fa fa-newspaper-o"></i> <span>Manage Instute Combination </span></a></li>
                                        </ul>
                                    </li>
   <li class="has-children">
...
<li class="has-children">
                                    ...
                                    <li><a href="http://localhost/Student%20Result%20Management%20System/feedback/admin/mainpage.php"><i class="fa fa-check-square-o"></i> <span> Feedback</span></a></li>
